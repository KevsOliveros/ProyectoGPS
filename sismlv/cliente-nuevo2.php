			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-12 col-lg-8">
						<input class="form-control" type="text" placeholder="Introduzca un nombre" name="nombre_cliente" required="required">
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class="row">
					...
					<div class="col-12 col-lg-8">
						<textarea  class="form-control" id="exampleFormControlTextarea1" rows="3" name="direccion_cliente" required="required"></textarea>
					</div>
				</div>
			</div>
